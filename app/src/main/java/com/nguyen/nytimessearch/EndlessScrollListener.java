...
public abstract class EndlessScrollListener implements AbsListView.OnScrollListener {
   ...
   // defines the process for actually loading more data based on page. returns true if more data is
   // being loaded; returns false if there is no more data to load.
